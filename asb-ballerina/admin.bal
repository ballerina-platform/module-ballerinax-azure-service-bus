...
public isolated client class ASBAdministration {
    ...
    public isolated function init(@display {label: "Azure Service Bus Admin Configurations"} string connectionString) returns Error? {
