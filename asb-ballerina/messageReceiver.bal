...
@display {label: "Azure Service Bus Message Receiver", iconPath: "asb.png"}
public isolated client class MessageReceiver {
    ...
    public isolated function init(string connectionString, string entityPath, string receiveMode = PEEKLOCK) returns error? {
    ...
    isolated remote function defer(@display {label: "Message"} Message message) 
        ...
        _ = check defer(self.receiverHandle, message?.lockToken.toString());
    ...
    isolated remote function close() returns Error? {
        var connectionResult = closeReceiver(self.receiverHandle);
